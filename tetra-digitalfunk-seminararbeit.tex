...
\chapter{Theoretische Einführung}\label{sec:einfuehrung}
...
\subsection{Das TDMA-Verfahren im TETRA-Standard}\label{sec:tdma-verfahren-tetra-standard}
...
Das Funk- und Zugangsnetz ist die wesentlichen Schnittstelle zwischen den Endgeräten und der rückwärtigen Netzwerkinfrastruktur.
...
\chapter{Vor- und Nachteile des TETRA-Digitalfunks}\label{sec:vor-und-nachteile}
...
\section{Vorteile des TETRA-Digitalfunks}\label{subsec:vorteile-tetra-digitalfunk}

\subsection{Gruppenruf, Einzelruf und Priorisierung}\label{subsubsec:gruppenruf-einzelruf-und-priorisierung}

\subsection{Bundesweite Kommunikation}\label{subsec:bundesweite-kommunikation}

\subsection{Abhör- und Informationssicherheit}\label{subsubsec:abhoer-und-informationssicherheit}

\subsection{Digitale Datendienste und Short Messages}\label{subsec:digitale-datendienste-und-short-messages}

\section{Nachteile des TETRA-Digitalfunks}\label{subsec:nachteile-tetra-digitalfunk}

\subsection{Netzausfälle und Störanfälligkeit}\label{subsubsec:netzausfaelle-und-stoeranfalligkeit}

\subsection{Benutzerfreundlichkeit und Bedienung}\label{subsubsec:benutzerfreundlichkeit-und-bedienung}

\chapter{Fazit und Ausblick}\label{sec:fazit-und-ausblick}
