...
Aus Gründen der besseren Lesbarkeit wird im Text verallgemeinernd die generisch maskuline Form, sofern möglich, verwendet. Diese Formulierungen umfassen gleichermaßen weibliche und männliche Personen.
\clearpage
...
Der \gsl{TETRA}-Standard beinhaltet hierfür standardmäßig eine Luftschnittstellenverschlüsselung, welche den reinen Übertragungsweg zwischen Endgerät und Basisstation schützt.
...
\chapter{Risiken und Gefahren des TETRA-Digitalfunks}\label{sec:risiken-und-gefahren}
